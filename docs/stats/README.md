...
Interactive dashboard showing traffic analytics for [PLACEHOLDER](https://github.com/OWNER/REPO).
...
|--------|------|----------|
| [Badge Gist](https://gist.github.com/USER/GISTID) | Public | Current stats, rolling 31-day daily history |
